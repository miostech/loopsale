...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "WhatsApp incluído (número e mensagens por nossa conta)",
  ...
  },
  {
    ...
    name: "Pro",
    priceMonthly: 897,
    priceNote: "+ 15% sobre vendas recuperadas",
    description: "Mensalidade + 15% sobre recuperadas.",
    ...
    maxMembers: 3,
    features: [
      "15% de comissão sobre vendas recuperadas",
      "Até 1.000 checkouts/mês",
      "Fluxos ilimitados",
  ...
  },
  {
    ...
    priceMonthly: 1990,
    priceNote: "+ 15% sobre vendas recuperadas",
    description: "Mais volume, mensalidade + 15%.",
    priceId: process.env.STRIPE_PRICE_PLUS ?? null,
    commissionRate: 0.15,
    includesSupport: true,
    chatFreeConversations: 1000,
    maxMembers: null,
    features: [
      "15% de comissão sobre vendas recuperadas",
      "Até 2.500 checkouts/mês",
      "Atendimento gerenciado incluído",
      "Tudo do Pro",
      "Membros ilimitados",
    ],
